        ...
        var getHtml = {
            ...
            page: function(_idx){
                ...
                var _html = '';
                    ...
                    _html += '                 <div class="uk-form-controls">';
                    _html += '                     <textarea name="pc" class="pc js-input uk-textarea uk-form-small" rows="10" placeholder="PC Files">' + _pages.pc + '</textarea>';
                    _html += '                 </div>';
                    _html += '             </div>';
                    _html += '             <div>';
                    _html += '                 <label class="uk-form-label" for="form-stacked-text">Mobile</label>';
                    _html += '                 <div class="uk-form-controls">';
                    _html += '                     <textarea name="mobile" class="mobile js-input uk-textarea uk-form-small" rows="10" placeholder="Mobile Files">' + _pages.mobile + '</textarea>';
                    _html += '                 </div>';
                    _html += '             </div>';
                    _html += '        </div>';
                    _html += '        <div class="uk-margin action">';
                    _html += '            <button class="uk-button uk-button-default button clear">초기화</button>';
                    _html += '        </div>';
                    _html += '    </div>';
                    _html += '</div>';

        ...
        return {
            init: function init(opts) {
                ...
                var parent = opts.parent || console.warn("no parent"),
                    ...
                    image1 = opts.image1 || console.warn("first image missing"),
                    image2 = opts.image2 || console.warn("second image missing");
                ...
                var threeScene = new THREE.Scene(),
                    threeCamera = new THREE.OrthographicCamera(parent.offsetWidth / -2, parent.offsetWidth / 2, parent.offsetHeight / 2, parent.offsetHeight / -2, 1, 1000),
                ...
                var setThree = function setThree() {
                    ...
                    threeWebGLrenderer.setSize(parent.offsetWidth, parent.offsetHeight);

                    parent.appendChild(threeWebGLrenderer.domElement);

                    var _addToGPU = function _addToGPU(t) {
                        threeWebGLrenderer.setTexture2D(t, 0);
                    };
                    var _texture1 = _threeTextureLoader.load(image1, function (texture) {
                        _addToGPU(texture);
                    });
                    var _texture2 = _threeTextureLoader.load(image2, function (texture) {
                        _addToGPU(texture);
                    });
                    var _disp = _threeTextureLoader.load(dispImage);
                    ...
                    var _geometry = new THREE.PlaneBufferGeometry(parent.offsetWidth, parent.offsetHeight, 1),
                ...
                var _toggle = {
                    on: function on() {
                        TweenMax.to(threeShaderMaterial.uniforms.dispFactor, speedIn, {
                            value: 1,
                            ease: easing
                        });
                    },
                    off: function off() {
                        TweenMax.to(threeShaderMaterial.uniforms.dispFactor, speedOut, {
                            value: 0,
                            ease: easing
                        });
                    }

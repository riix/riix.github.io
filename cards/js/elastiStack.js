...
(function(window) {
    ...
    var is3d = !!getStyleProperty('perspective'), // support
    ...
    ElastiStack.prototype._moveAway = function(instance) {
        ...
        var self = this,
            onEndTransFn = function() {
                ...
                setTimeout(function() {
                    classie.add(self._lastItem(), 'animate'); // the upcoming one will animate..
                    self._setStackStyle(); // reset style
                }, 25);

                self._initDragg(); // add dragging capability
                self._initEvents(); // init drag events on new current item
                self.options.onUpdateStack(self.current); // callback
            };
